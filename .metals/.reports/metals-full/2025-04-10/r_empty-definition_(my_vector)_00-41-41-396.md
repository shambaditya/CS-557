error id: file://<WORKSPACE>/src/main/scala/PE.scala:72
  ...
  val io = IO(new Bundle {
    ...
    switch(state) {
      ...
      is(running) {
        counter := counter + 1.U
        addr_PE_reg := addr_PE_reg
        when (tmp > dist_in_topk || counter === UInt(num_cycle - 1)){
          /* this case prioritize this PE's enq a@@t its last compute cycle */
